        ...
        <div className="flex flex-col lg:flex-row items-center">
          ...
          >
            <h1 className="font-bebas text-5xl md:text-7xl xl:text-8xl leading-none mb-6">
              YOU <span className="text-orange drop-shadow-[0_0_10px_rgba(255,90,31,0.5)]">DREAM</span> IT,<br/>
              WE <span className="text-purple drop-shadow-[0_0_10px_rgba(122,63,255,0.5)]">DO</span> IT.
            </h1>
            <p className="font-space text-xl md:text-2xl text-gray mb-8 max-w-xl">
              We fuse creativity and engineering to power your brand's growth with digital solutions that make an impact.
            </p>
